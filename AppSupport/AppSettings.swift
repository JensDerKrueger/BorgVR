...
enum RenderBackgroundMode: String, CaseIterable, Identifiable {
  ...
  var label: String {
    switch self {
      case .system: return String(localized: "System color")
      case .solid: return String(localized: "Custom color")
      case .gradient: return String(localized: "Vertical gradient")
    }
  }
}
...
final class AppSettings: ObservableObject {
  ...
  static let values: [String: Any] = [
    ...
    "renderBackgroundPrimaryRed": 0.2156862745,
    "renderBackgroundPrimaryGreen": 0.8274509804,
    "renderBackgroundPrimaryBlue": 0.9411764706,
    "renderBackgroundPrimaryAlpha": 1.0,
    "renderBackgroundSecondaryRed": 0.0705882353,
  ...
  @AppStorage("enableDatasetServer") var enableDatasetServer: Bool = AppSettings.bool("enableDatasetServer")
  ...
  func resetBackgroundServerDefaults() {
    enableDatasetServer = Self.boolDefault("enableDatasetServer")
